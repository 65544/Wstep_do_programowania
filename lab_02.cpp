...
//-------------------Zadanie 6----------------------
	...
	*/
	//--------------------Zadanie 7----------------------
	//Niżej zrobiłem drugą wersję zadania 7, tak by według mnie miało sens, ponieważ nie byłem w stanie zrozumieć treści zadania
	/*
	int a, b;
	...
	if (a == 2 || b == 1) cout << "Mozesz kupic samochod! Znizki na samochod nie ma. ";
	if (a == 2 || b == 2) cout << "Zakup samochodu trzeba odlozyc na pozniej..., Znizki na samochod nie ma. ";
	if (a == 1 || b == 1) cout << "Mozesz kupic samochod! ";
	*/
	//--------------------Zadanie 7 2.0----------------------
